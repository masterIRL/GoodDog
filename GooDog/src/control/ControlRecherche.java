...
public class ControlRecherche {
	...
	public List<String> rechercheMotCle(String mot, int occurrenceMotCle) {
		...
		// celui pr�sent en parametre de CETTE fonction (occurrenceMotCle) et ceux sup ou egale
		//tu stocke le mot dnas le "listMotCle"

		Comparaison compare = new Comparaison();
		for (Map.Entry<String,Integer> entry : compare.comparaisonMotCle(mot).entrySet() ) {
