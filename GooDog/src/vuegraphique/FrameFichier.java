...
public class FrameFichier  extends JFrame{
	...
	private Box boxCombo = Box.createHorizontalBox();
	...
	private void initialisation() {
		...
		lancerRecherche.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String extension = nom.substring(nom.length()-3);
	...
	public void rechercheFichier() {
		if(typeFichier != null)
		{
			if(!admin) {
				...
				panAdmin.initBoxMiseEnPageResultat();
				switch(typeFichier) {
				case TEXTE:
			...
			System.out.println("Choisissez un fichier"); //non valide la recherche
		}
