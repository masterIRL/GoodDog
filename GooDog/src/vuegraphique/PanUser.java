...
public class PanUser extends JPanel {
	...
	public void showAdmin() {
		...
		this.panTop.remove(labelConnect);
		this.labelConnect = null;
		this.labelConnect = new ImageJLabel("RESSOURCE/IMAGE/LogoAdmin.png");
	...
	public void showUser() {
		...
		this.panTop.remove(labelReglage);
		this.labelReglage = null;
		this.labelReglage = new ImageJLabel("RESSOURCE/IMAGE/IconeReglage.png");
	...
	public void initialisation() {
		...
		panTop.setSize(labelReglage.getSize());
