...
public class FrameRechercheAdmin extends JFrame {
	...
	public FrameRechercheAdmin (ControlRecherche controlRecherche) {
		...
		this.panTopRechercheA.setBackground(Color.WHITE);
		this.panTopRechercheA.setLayout(new BorderLayout());
		...
		this.panTopRechercheA.add(labelAdmin, BorderLayout.EAST);
		this.panFinalRechercheA.add(panTopRechercheA,BorderLayout.NORTH);
...
/*		BufferedImage imageConnect=null;
		...
		panRechercheA.add(labelConnexion); */
		...
		validerMotCle.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (controlRecherche.verifierMotCle(entreeMotCle)) {
					...
					panTopRechercheA.setVisible(false);
					boxMiseEnPageMotCleResultat.setVisible(true); 
					panRechercheA.repaint(); 
		...
		this.panRechercheA.add(boxMiseEnPageMotCle);
		this.panRechercheA.add(boxMiseEnPageMotCleResultat);
	...
	private void initBoxMiseEnPageMotCleResultat() {
		...
		boutonRetour.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				boxMiseEnPageMotCleResultat.setVisible(false); 
				panFinalRechercheA.setBackground(Color.WHITE);
				panRechercheA.setBackground(Color.WHITE);
				panTopRechercheA.setVisible(true);
				boxListeResultats.removeAll();
				boxMiseEnPageMotCleResultat.remove(boutonRetour);
				boxMiseEnPageMotCle.setVisible(true); 
				panFinalRechercheA.repaint(); 
			}
		});
	}
	...
	private void resultatsMotCles(List<String> liste) {
		panRechercheA.setBackground(new Color(220, 220, 255));
		panFinalRechercheA.setBackground(new Color(220, 220, 255));
